package fxgeditor.parser.filters 
{
	...
	public class GradientBevelFilter implements IFilter
	{
		...
		public static var LOCALNAME:String = "GradientBevelFilter";
		...
		{
			return new flash.filters.GradientBevelFilter(_distance, _angle, _colors, _alphas , _ratios, _blurX, _blurY , _strength, _quality, _type, _knockout );
		}
