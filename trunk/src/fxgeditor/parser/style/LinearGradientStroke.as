package fxgeditor.parser.style 
{
	...
	public class LinearGradientStroke extends LinearGradient implements IStyleParser , IGradient, IStroke , IColor
	{
		public static var LOCALNAME:String = "LinearGradientStroke";
		...
		/*
		override public function setFxgAttr( node:XML , localName:String = null):void
		{
			localName = localName ? localName : LOCALNAME;
			super.setFxgAttr( node , localName );
			_stroke.setFxgAttr( node , localName );
		}
		*/
